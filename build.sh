...
docker build . --platform linux/amd64 --tag voldlu/dolibarr-php:"$DOLIBARR_GIT_VERSION" --file docker/php/Dockerfile
docker build . --platform linux/amd64 --tag voldlu/dolibarr-nginx:"$DOLIBARR_GIT_VERSION" --file docker/nginx/Dockerfile
