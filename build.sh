...
docker build . ${BUILD_ARGS:-} --tag voldlu/dolibarr-php:"$DOLIBARR_GIT_VERSION" --file docker/php/Dockerfile
docker build . ${BUILD_ARGS:-} --tag voldlu/dolibarr-nginx:"$DOLIBARR_GIT_VERSION" --file docker/nginx/Dockerfile
